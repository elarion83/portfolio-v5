...
const translations = {
  en: {
    ...
    'home.services.headless.title': 'WordPress Headless or Clean Code',
    'home.services.headless.desc': 'Decoupled front (React, Next.js) with WordPress as headless CMS, or legacy code refactoring for maintainability.',
    'home.services.audit.title': 'WordPress Audit',
    'home.services.audit.desc': 'Technical and security audit, code review, performance and SEO assessment. Clear report and action plan.',
    'home.availability.title': 'Available for',
    'home.availability.subtitle': 'Long-term missions, short sprints or ongoing support—tell me your needs.',
  ...
  fr: {
    ...
    'home.services.headless.title': 'WordPress Headless ou Clean Code',
    'home.services.headless.desc': 'Front découplé (React, Next.js) avec WordPress en headless, ou refonte de code legacy pour la maintenabilité.',
    'home.services.audit.title': 'Audit WordPress',
    'home.services.audit.desc': 'Audit technique et sécurité, revue de code, état des lieux performance et SEO. Rapport clair et plan d\'action.',
    'home.availability.title': 'Dispo pour',
    'home.availability.subtitle': 'Missions longues, sprints courts ou accompagnement au long cours—dites-moi vos besoins.',
