...
const {
  ...
  Users,
  CalendarPlus2
} = lazy(() => import('../components/icons'));

// Fallback pour les icônes
const IconFallback = () => <span className="w-4 h-4 bg-[#e28d1d]/20 rounded animate-pulse" />;

// Composant de fallback simple pour le contenu principal
const MainContentFallback = () => (
  <div className="min-h-screen relative overflow-hidden">
    <div className="absolute inset-0 bg-[#261939]" />
