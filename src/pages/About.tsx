              ...
              >
                ...
                <div className="text-center">
                  ...
                  <p className="text-[#e28d1d]">
                    {language == 'en' ? testimonials[activeTestimonial].acf.tem_post_title_en :  testimonials[activeTestimonial].acf.tem_statut}</p>
                </div>
              </motion.div>
            </AnimatePresence>
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#261939] to-gray-900">
      ...
      <div className="py-20 px-4 bg-[#261939]/30">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            {/* Timeline line - now full height on mobile */}
          ...
          >
            <Link to="/contact">
              ...
              >
                ...
                <Link to="https://calendly.com/gruwe-nicolas/30min">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
